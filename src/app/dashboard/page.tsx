          ...
          >
            ...
            <div className="bg-surface-container-lowest p-6 rounded-3xl luxury-shadow border border-outline-variant/10 flex flex-col md:flex-row gap-8 items-center group cursor-pointer">
              <div className="w-full md:w-64 h-48 rounded-2xl overflow-hidden relative">
                <img alt="Delhi at night" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAv0rMKrGHmZ413vbZfLaQj4_MmVzBURqlcBtKE79owvc_fch9SWOVh5iel5yfIKTX_AatyEmpdvjezSVKIpOKnvbu-OzL6A6ciIwPwYmScR5qNPEPXR8myn_TVvscFLrJPPF5SpOdCv3DSSvIu4J8CyoIYot6OKlN-4fFaKAt8NFtb9ixmG99QUJ2N6lcnwoRFzJTwdvM_8Wy5WLMXuwSDz58jHmuh-ulPN6kzfXmqCt6UOXJRcLU9fzF4a11gA1UdXMtW08H2Vkc" />
              ...
              <div className="flex-1 space-y-4">
                ...
                <h3 className="font-headline text-2xl font-bold text-on-surface">The Golden Triangle</h3>
                <p className="font-body text-sm text-on-surface-variant leading-relaxed line-clamp-2">
                  A comprehensive journey spanning from the ultra-modern skyline of Delhi to the tranquil temples of Jaipur, with curated bullet train transfers.
                </p>
                <div className="pt-2">
               ...
               <div className="space-y-8">
                 <div className="relative flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="font-body text-xs text-on-surface-variant mt-1">BOM to DEL via Vistara Premium.</p>
                 ...
                 <div className="relative flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="font-body text-xs text-on-surface-variant mt-1">AI created "The Golden Triangle".</p>
